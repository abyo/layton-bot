...
module.exports = {
  ...
  async runInteraction(client, interaction, guildSettings) {
    ...
    if (!member.isCommunicationDisabled()) return interaction.reply({ content: 'Ce membre ne peut pas être démute par le bot car il n\'est pas mute!', ephemeral: true });
    ...
    await interaction.reply({ content: `Le membre ${member} a été démute!`, ephemeral: true });
